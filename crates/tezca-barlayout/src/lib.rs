...
impl Mod {
    ...
    pub fn hint(self) -> &'static str {
        match self {
            ...
            Mod::Cpu => "CPU load; click for temps and processes",
            Mod::Mem => "Memory used; click for the breakdown",
            Mod::Gpu => "GPU load; auto-hides without a source",
            Mod::Network => "Wi-Fi/ethernet glyph; click for detail",
